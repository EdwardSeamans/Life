...
public class IterationSettings {
    public static final int COLUMNS = 600;                      //Width - Width in Cells
    public static final int ROWS = 600;                         //Height - Height in Cells
    ...
    public static final int MAX_HISTORY = 100;                 //Number of generations saved in history and/or checked for cycles
    ...
    //public byte[] greenByte = color.

    public static final long TARGET_FRAME_RATE = 225;           //Target Frame Rate, need to find formula, should automate to fastest unless set
