...
public class IterationSettings {
    public static final int COLUMNS = 320;                                                          //User Window, field
    public static final int ROWS = 320;                                                             //User Window, field
    ...
    public static final long TARGET_FRAME_RATE = 106;                                               //properties
